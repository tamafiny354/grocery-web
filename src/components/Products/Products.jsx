...
const Products = () => {
    ...
    let filteredItems = activeTap === 'All'
    ? ProductList : ProductList.filter(item=>item.category === activeTap);
            ...
            <div className='flex flex-wrap gap-3 justify-center mt-10'>
                {categories.map(category=>{
                   return(
                    ...
                    ${activeTap === category ? 'bg-gradient-to-b from-orange-400 to-orange-500 text-white' : 'bg-zinc-100'}`}
